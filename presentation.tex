...
\begin{frame}{A cautionary tale}
    ...
    \only<2> {
        \LARGE \textgoth{There was: a prince{s:}{s:}}
        \includegraphics[width=0.9\textwidth]{img/works-on-my-machine.pdf}
    }
    \only<3> {
        \huge \textgoth{She goe{s:} to the Kingdom Univers:ity Bal}
        \includegraphics[width=0.9\textwidth]{img/works-on-my-machine.pdf}
    }
    \only<4> {
        \huge \textgoth{Where s:he falls: in love with XXX}
        \includegraphics[width=0.9\textwidth]{img/works-on-my-machine.pdf}
    }
    \only<5> {
        \huge \textgoth{But XXX s:uddenly run}
        \includegraphics[width=0.9\textwidth]{img/works-on-my-machine.pdf}
    }
    \only<6> {
        \huge \textgoth{She only has: a photo of her s:hoe}
        \includegraphics[width=0.9\textwidth]{img/works-on-my-machine.pdf}
    }
    \only<7> {
        \huge \textgoth{Thankgodfully, there's: the DeepShoe paper!}
        \includegraphics[width=0.9\textwidth]{img/works-on-my-machine.pdf}
    }
    \only<8> {
        \huge \textgoth{Which requires: Python...}
        \includegraphics[width=0.9\textwidth]{img/works-on-my-machine.pdf}
    }
    \only<9> {
        \huge \textgoth{Actually Python2}
        \includegraphics[width=0.9\textwidth]{img/works-on-my-machine.pdf}
    }
    \only<10> {
        \huge \textgoth{And opencv}
        \includegraphics[width=0.9\textwidth]{img/works-on-my-machine.pdf}
    }
    \only<11> {
        \huge \textgoth{Actually opencv-v1.14}
        \includegraphics[width=0.9\textwidth]{img/works-on-my-machine.pdf}
    }
    \only<12> {
        \huge \textgoth{But s:he already has: v2.0 installed}
        \includegraphics[width=0.9\textwidth]{img/works-on-my-machine.pdf}
    }
    \only<13> {
        \huge \textgoth{Etc.}
...
\begin{frame}{Limits}
    \begin{alertblock}{Nix}
        \begin{itemize}
            \item Steep learning curve
            \item Everything has to be "Nixified" (Nixpkgs)
        \end{itemize}
    \end{alertblock}
\end{frame}
...
\begin{frame}{Usages}
    \begin{itemize}
        ...
        \item NixOS: declarative system configuration (NixOS)
        \item Nix shell: project-specific environments
    \end{itemize}
\end{frame}
...
\begin{lstlisting}[language=Nickel,title={Heterogeneous data}]
services = [
  "init",
...
\begin{frame}{Summary}
    \begin{itemize}
        ...
        \item \couleur{orange-vivid-tangerine}{Nix expressions} have limitations. We started
            \couleur{orange-vivid-tangerine}{Nickel} to overcome them.
        \item There is a space for alternative type systems.
            \couleur{orange-vivid-tangerine}{Gradual typing} and
            \couleur{orange-vivid-tangerine}{first-class contracts} is an
